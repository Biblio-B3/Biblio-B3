...
1. `yarn all` a la racine du projet pour avoir postgres et pgadmin de lancé.
2. Se connecter a pgadmin avec les identifiants present dans le docker compose.
3. Ajouter la base de donnée avec les identifiant present dans le docker compose.
4. Utiliser la focntion `Restore` sur base de données pour récuperer une db seedé.
